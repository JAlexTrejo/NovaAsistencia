...
const BulkActionsToolbar = ({ 
  ...
  const handleBulkAction = () => {
    if (bulkActionType && (bulkActionValue || ['export-data', 'send-notification']?.includes(bulkActionType))) {
      onBulkAction({
  ...
  const canExecuteAction = () => {
    if (['export-data', 'send-notification']?.includes(bulkActionType)) {
      return true;
    }
    return bulkActionType && bulkActionValue;
  };
